...
public class SourceOthersInterview extends Activity {
ImageButton btnDone;
	
	protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.source_others_interview);
    ...
    class btnDoneListener implements OnClickListener {
		...
		public void onClick(View a) {
			Intent intent = new Intent(SourceOthersInterview.this, SourceFinalCitation.class);
