...
public class SourcePubNewspaper extends Activity {
ImageButton btnDone;
	
	protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.source_pub_newspaper);
    ...
    class btnDoneListener implements OnClickListener {
		...
		public void onClick(View a) {
			Intent intent = new Intent(SourcePubNewspaper.this, SourceFinalCitation.class);
