...
public class SourceOthersOnlineDisc extends Activity {
ImageButton btnDone;
	
	protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.source_others_onlinedisc);
    ...
    class btnDoneListener implements OnClickListener {
		...
		public void onClick(View a) {
			Intent intent = new Intent(SourceOthersOnlineDisc.this, SourceFinalCitation.class);
