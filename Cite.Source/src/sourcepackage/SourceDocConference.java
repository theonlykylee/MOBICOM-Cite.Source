...
public class SourceDocConference extends Activity {
	ImageButton btnDone;
	
	protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.source_doc_conference);
    ...
    class btnDoneListener implements OnClickListener {
		...
		public void onClick(View a) {
			Intent intent = new Intent(SourceDocConference.this, SourceFinalCitation.class);
