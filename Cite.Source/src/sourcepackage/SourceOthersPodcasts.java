...
public class SourceOthersPodcasts extends Activity {
ImageButton btnDone;
	
	protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.source_others_podcasts);
    ...
    class btnDoneListener implements OnClickListener {
		...
		public void onClick(View a) {
			Intent intent = new Intent(SourceOthersPodcasts.this, SourceFinalCitation.class);
